...
public class Main {
    ...
    public static int[] heroesHealth = {280, 270, 250, 200, 400, 230, 260, 210};
    public static int[] heroesDamage = {10, 15, 20, 0, 5, 20, 22, 25};
    ...
    private static void berserkSkill() {
